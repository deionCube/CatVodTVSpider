...
public class Cokemv extends Spider {
    ...
    public void init(Context context) {
        super.init(context);
        try {
            playerConfig = new JSONObject("{\"cokemv0555\":{\"sh\":\"COKEMV\",\"pu\":\"\",\"sn\":0,\"or\":999},\"cokeqie01\":{\"sh\":\"極速路線\",\"pu\":\"\",\"sn\":0,\"or\":999},\"xin\":{\"sh\":\"高速路線\",\"pu\":\"\",\"sn\":0,\"or\":999},\"90mm\":{\"sh\":\"藍光號路\",\"pu\":\"\",\"sn\":0,\"or\":999},\"age01\":{\"sh\":\"動漫一線\",\"pu\":\"\",\"sn\":0,\"or\":999},\"age02\":{\"sh\":\"動漫二線\",\"pu\":\"\",\"sn\":0,\"or\":999},\"toutiao\":{\"sh\":\"海外路線\",\"pu\":\"\",\"sn\":0,\"or\":999},\"cokemv001\":{\"sh\":\"海外二號線\",\"pu\":\"https://cokemv.me/cokemv.php?url=\",\"sn\":1,\"or\":999},\"mahua\":{\"sh\":\"海外(禁國內)\",\"pu\":\"\",\"sn\":0,\"or\":999}}");
    ...
    public String homeContent(boolean filter) {
        try {
            ...
            try {
                // 取首页推荐视频列表
                Element homeList = doc.select("div.module-main").get(10);
    ...
    public String categoryContent(String tid, String pg, boolean filter, HashMap<String, String> extend) {
        try {
            ...
            // 取页码相关信息
            Elements pageInfo = doc.select("div.page");
            if (pageInfo.size() == 0) {
    ...
    public String detailContent(List<String> ids) {
        try {
            ...
            Elements span_text_muted = doc.select("div.module-info-content div.module-info-item span");
